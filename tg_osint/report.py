...
@media(max-width:620px){{:root{{--gutter:14px;--bar:50px}}html,body{{width:100%;max-width:100%;overflow-x:hidden}}.page{{width:100%;max-width:100%;padding-left:var(--gutter);padding-right:var(--gutter)}}.top{{width:100%;max-width:100%;padding-left:var(--gutter);padding-right:var(--gutter);gap:8px}}.top .brand{{min-width:0}}.top .stamp{{display:none}}.find{{min-width:0;max-width:none}}.find input{{min-width:0}}.hero,.card,.sect,.evidence,.ioc{{min-width:0;max-width:100%}}.hero{{padding-top:18px;overflow:hidden}}.who,.names,.chips{{min-width:0;max-width:100%}}.sigil{{width:48px;height:48px;border-radius:13px;font-size:17px}}.cta{{width:100%;justify-content:center;order:3}}.chip{{max-width:100%;min-width:0;overflow-wrap:anywhere;word-break:break-word}}.tape,.facts,.fold{{min-width:0;max-width:100%;overflow-x:hidden}}.plot{{min-width:0;width:100%}}.fact{{max-width:100%}}.tiles{{grid-template-columns:repeat(2,minmax(0,1fr));min-width:0}}.tile{{min-width:0;overflow:hidden}}table{{display:block;width:100%;max-width:100%;background:var(--panel)}}tr:first-child{{display:none}}tr,tr:nth-child(even){{display:block;width:100%;max-width:100%;padding:12px 14px;background:var(--panel);border-bottom:1px solid var(--hair)}}tr:last-child{{border-bottom:0}}tr:not(:first-child):hover{{background:var(--panel)}}td{{display:block;width:100%;max-width:100%;padding:0;text-align:left;white-space:normal;overflow-wrap:anywhere;word-break:break-word}}td:not([data-label]),td[data-label][data-empty]{{display:none}}td[data-main]{{font-family:var(--ui);font-size:14.5px;font-weight:600;line-height:1.35;padding-bottom:5px;max-width:100%;overflow-wrap:anywhere;word-break:break-word}}td[data-label]:not([data-main]){{font-family:var(--mono);font-size:11.5px;line-height:1.6;color:var(--dim);max-width:100%;overflow-wrap:anywhere;word-break:break-word}}.note,.sect-title,.evidence-body,.meta{{max-width:100%;min-width:0;overflow-wrap:anywhere;word-break:break-word}}.sect-title{{flex-wrap:wrap}}.sect-title>div{{min-width:0;max-width:100%}}.iocgrid{{grid-template-columns:minmax(0,1fr)}}.ioc ul{{min-width:0;overflow-x:hidden;overflow-wrap:anywhere;word-break:break-word}}.evidence summary{{min-width:0;max-width:100%;align-items:flex-start}}.evidence summary strong,.evidence summary .muted{{min-width:0;max-width:100%;overflow-wrap:anywhere;word-break:break-word}}.evidence-body>a{{display:block;max-width:100%;overflow-wrap:anywhere;word-break:break-all}}pre{{max-width:100%;width:100%;overflow:auto;overflow-wrap:anywhere;word-break:break-word;white-space:pre-wrap}}}}
