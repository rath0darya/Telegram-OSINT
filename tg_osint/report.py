...
def build_report(target, case_id, evidence, errors, analysis=None):
    return {
        "schema_version":"1.2.0","tool":"Telegram-OSINT","generated_at":now_iso(),
...
<section><h2>Engagement</h2><div class="grid"><div class="card stat"><span class="muted">Total views</span><strong>{eng.get("total_views",0)}</strong></div><div class="card stat"><span class="muted">Average views</span><strong>{eng.get("average_views",0)}</strong></div><div class="card stat"><span class="muted">Max views</span><strong>{eng.get("max_views",0)}</strong></div><div class="card stat"><span class="muted">Total forwards</span><strong>{eng.get("total_forwards",0)}</strong></div></div></section>
<section><h2>IOCs</h2><div class="iocgrid">{"".join(ioc_cards)}</div></section>
...
<section><h2>Evidence</h2>{"".join(cards) or '<div class="card muted">No evidence was collected.</div>'}</section>
